...
Sign
{
	...
	backColor: Qt.darker("lightblue", 1.15)

	Button
	{
		id: mainButton
		width: parent.width; height: parent.oHeight
	...
	{
		mainButton.textLabel=model;
	}
	function updateEnabled(enabled)
	{
		if (enabled) press(mainButton);
		else unpress(mainButton);
	}
}
